    ...
    public abstract class Payment : Entity{
        protected Payment( DateTime paidDate, DateTime expireDate, decimal total, decimal totalPaid, string payer, Document document, Address address, Email email)
        {
            ...
            AddNotifications(new Contract()
                .Requires()
                .IsLowerOrEqualsThan(0, Total, "Payment.Total","O total não pode ser igual a zero.")
                .IsGreaterOrEqualsThan(Total, TotalPaid, "Payment.TotalPaid","O o valor pago é menor que o valor do pagamento.")
            );
        }
